...
// Node-style tokens used by Antigravity. Terminal is the trailing
// "<app>/<version>" suffix that the Rust codex_cli_rs appends after the
// parenthetical OS/arch group.
